...
class TopEntryTestCase(unittest.TestCase):
    ...
    def testParseUptime(self):
        ...
        line = 'top - 10:51:32 up 1 day, 0 min,  1 user,  load average: 0.00, 0.01, 0.05'
        self.checkParseUptime(line, '10:51:32', (1 * 24 * 60), 1, 0.00, 0.01, 0.05)
        
        line = 'top - 10:51:32 up 1 day, 59 min,  1 user,  load average: 0.00, 0.01, 0.05'
        self.checkParseUptime(line, '10:51:32', (1 * 24 * 60) + 59, 1, 0.00, 0.01, 0.05)
