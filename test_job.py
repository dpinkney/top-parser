...
class JobTestCase(unittest.TestCase):
    ...
    def testParse(self):
        ...
        line = '  167 root      20   0  157m  11m  11m S   0.0  0.1   0:00.11 systemd-journal'
        self.checkParse(line, '167', 'root', '20', 0, (157 * 1024), (11 * 1024), (11 * 1024), 'S', 0.0, 0.1, '0:00.11', 'systemd-journal')
